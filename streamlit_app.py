...
# CẤU HÌNH & VERSION
# =============================================================================
APP_VERSION = "V4856 - FIXED PO IMPORT (LEGACY ALGO)"
...
# --- SMART EXCEL IMPORT (DÙNG CHO TAB 2) ---
...
# --- UI ---
st.title("HỆ THỐNG CRM QUẢN LÝ (V4856)")
...
with t4:
    ...
    with c1:
        ...
        if up_s:
            # FIX LOGIC NHẬP PO NCC (DÙNG ALGO CŨ)
    ...
    with c2:
        ...
        if up_c:
            # FIX LOGIC NHẬP PO CUST (DÙNG ALGO CŨ)
